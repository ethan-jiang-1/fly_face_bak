...
def do_extract_hairstyles(src_dirs, dst_dir, plot_img=True, save_img=True):
    ...
    for src_dir in src_dirs:
        ...
        for filename in filenames:
            img = ffg.process_image_for_fename(filename, "hair")
...
def analysis_all_files():
    ...
    src_dirs = [] 
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/00")
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/01")
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/02")
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/03")
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/04")
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/05")
    src_dirs.append("data/dataset_org_hair_styles/Version 1.4/06")
