...
data = DataLoader.from_folder("../_dataset_beard_styles")
...
model._export_tflite('cls_beard_1.tflite',  quantization_config=config, with_metadata=True, export_metadata_json_file=True)
