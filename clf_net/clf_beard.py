...
model_path = "{}/cls_beard_1.tflite".format(dir_this)
...
def do_exp(img_pathname):
    ...
    id = ClfBeard.get_category_id(img_array)
    print("category id for {} is {}".format(img_pathname, id))
    return id

if __name__ == '__main__':
    filename = "./_reserved_output_feature_gen/02_000_0000_unified_shift_full.jpg"
    do_exp(filename)
